 ...
 *
 * @param {{ version?: number, cipher: number, key: Uint8Array, iv: Uint8Array }} opts
 *   `iv` is the 12-byte static IV for TLS 1.3, the 4-byte implicit salt for TLS 1.2.
 * @returns {Promise<{
 *   version: number,
 *   encrypt(seq: number|bigint, type: number, plaintext: Uint8Array,
 *           opts?: { padding?: number }): Promise<Uint8Array>,
 *   decrypt(seq: number|bigint, body: Uint8Array, header: Uint8Array):
